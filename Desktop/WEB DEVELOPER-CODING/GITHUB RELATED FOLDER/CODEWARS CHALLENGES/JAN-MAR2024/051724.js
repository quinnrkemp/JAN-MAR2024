...
// }
// If there is more than one condition to judge, we can use the 
// compound if...else statement. For example:
...
// Condition and statement separated by "?", different statement 
// separated by ":" in both Ruby and JS; in Python you put the condition 
// in the middle of two alternatives. The two examples above can be 
...
// When you have finished the work, click "Run Tests" to see if your code 
// is working properly.
