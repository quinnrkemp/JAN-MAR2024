// CHALLENGE NAME-  Find Multiples of a Number  (second attempt)

    // DESCRIPTION:

    // In this simple exercise, you will build a program 
    // that takes a value, integer , and returns a list 
    // of its multiples up to another value, limit . If 
    // limit is a multiple of integer, it should be included 
    // as well. There will only ever be positive integers 
