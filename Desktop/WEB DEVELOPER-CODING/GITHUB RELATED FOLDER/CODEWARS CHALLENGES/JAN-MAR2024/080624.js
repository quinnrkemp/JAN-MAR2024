    // CHALLENGE NAME-  Training JS #6: Basic data      (#2)
    // types--Boolean and conditional statements if..else

    // DESCRIPTION:

    // Task
    // Coding in function trueOrFalse, function accept 1 parameters:val, try to 
    // use the conditional statement if...else, if val value is false (val==false 
    //     or it can convert to false), should return a string "false", if not, 
