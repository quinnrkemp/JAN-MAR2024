 // CHALLENGE NAME-  A Needle in the Haystack
    ...
    // ["hay", "junk", "hay", "hay", "moreJunk", "needle", 
    ...
    function findNeedle(haystack) {
        let isNeedle = (element) => element ==='needle'
        let findNeedle= haystack.findIndex(isNeedle) 
        return `found the needle at position ${findNeedle}` 
          // your code here
        }