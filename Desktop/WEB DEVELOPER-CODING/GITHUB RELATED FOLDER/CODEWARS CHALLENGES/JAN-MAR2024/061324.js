// CHALLENGE NAME-  Quadratic Coefficients Solver   (#2)

// DESCRIPTION:

// In this Kata you are expected to find the coefficients of 
// quadratic equation of the given two roots (x1 and x2).
...
// Since there are infinitely many solutions to this problem, 
// we fix a = 1.
...
// Example
// quadratic(1,2) = (1, -3, 2)
// This means (x-1) * (x-2) = 0; when we do the multiplication 
// this becomes x^2 - 3x + 2 = 0
