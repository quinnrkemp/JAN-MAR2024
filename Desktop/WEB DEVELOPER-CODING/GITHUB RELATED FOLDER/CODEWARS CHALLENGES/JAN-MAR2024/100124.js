 // CHALLENGE NAME-  My head is at the wrong end (redo)
    ...
    // given an array which will have three values (tail, body, 
    //     head). It is your job to re-arrange the array so 
    //     that the animal is the right way round (head, body, 
    //         tail).
