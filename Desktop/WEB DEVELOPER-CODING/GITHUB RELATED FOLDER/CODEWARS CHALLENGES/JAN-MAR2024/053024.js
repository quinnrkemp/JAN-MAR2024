// CHALLENGE NAME-  Transportation on vacation  (#2)

// DESCRIPTION:

// After a hard quarter in the office you decide to get some 
// rest on a vacation. So you will book a flight for you and your 
// girlfriend and try to leave all the mess behind you.

// You will need a rental car in order for you to get around 
// in your vacation. The manager of the car rental makes you some 
// good offers.
...
function rentalCarCost(d) {
    if (d>=7) {
        ...
        return (d*40)-20    // Your solution here
      }
      return d*40
    }