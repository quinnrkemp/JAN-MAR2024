    ...
    //     and minimum, etc., depending on the language ) that receive 
    //     a list of integers as input, and return the largest and 
    //     lowest number in that list, respectively. Each function 
    //     returns one number.
