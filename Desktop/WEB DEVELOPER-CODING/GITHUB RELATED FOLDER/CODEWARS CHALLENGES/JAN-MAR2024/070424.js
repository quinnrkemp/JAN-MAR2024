...
// 1 Can you write a solution that will return null2 for both [] and 
// [ x ] though? (This is an empty array and one with a single number and 
//     is not tested for, but you can write your own example test. )
