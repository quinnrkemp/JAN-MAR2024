    ...
    // some cut-rate optical character recognition 
    // software for scanning in the text of old novels 
    // to your database. At first it seems to capture 
    // words okay, but you quickly notice that it throws 
    ...
    // solution to take this garbled text and remove all 
    // of the numbers. Your program will take in a string 
    // and clean out all numeric characters, and return a 
    // string with spacing and special characters 
    // ~#$%^&!@*():;"'.,? all intact.
