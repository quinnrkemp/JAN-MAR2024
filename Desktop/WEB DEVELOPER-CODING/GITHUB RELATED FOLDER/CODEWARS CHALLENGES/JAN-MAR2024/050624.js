// CHALLENGE NAME-  Remove First and Last Character Part Two  (#2)
...
// same character sequences except the first and the last ones but 
// this time separated by spaces.

// If the input string is empty or the removal of the first and 
// last items would cause the resulting string to be empty, return 
// an empty value (represented as a generic value NULL in the 
// examples below).
